define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/edit/profile",
    "title": "editProfileGet",
    "name": "editProfileGet",
    "version": "3.0.0",
    "description": "<p>this will redirect to editProfileGet</p>",
    "group": "EditRouter",
    "success": {
      "examples": [
        {
  ...
  },
  {
    ...
    "error": {
      "examples": [
        {
          "title": "Error-Respone:",
          "content": "res.render(\"edit/edit-profile\", {\n                   \"currentUrl\": \"edit-profile\",\n                   \"profile\": {\n                       \"firm\": req.body.firm,\n                       \"name\": req.body.name,\n                       \"street\": req.body.street,\n                       \"streetNr\": req.body.streetNr,\n                       \"postal\": req.body.postal,\n                       \"place\": req.body.place,\n                       \"vat\": req.body.vat,\n                       \"iban\": req.body.iban,\n                       \"bic\": req.body.bic,\n                       \"tel\": req.body.tel,\n                       \"email\":  req.body.email,\n                       \"_id\": req.params.idp,\n                       \"fromUser\":req.session._id\n                   },\n                   \"settings\": settings,\n                   \"title\": title,\n                   \"role\": role\n               });",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "url": "/logout/",
    "title": "logoutGet",
    "description": "<p>Deletes and makes a clean new session, and redirects to the login page</p>",
    "name": "logoutGet",
    "group": "LogoutRouter",
    "success": {
      "examples": [
    ...
    "filename": "src/controllers/logoutController.js",
    "groupTitle": "LogoutRouter"
  },
  {
    "version": "3.0.0",
    "type": "get",
